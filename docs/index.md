...
| [Tick 回测与纸面研究](backtesting.md) | Tick 归档、纸面撮合、事件回放和指标口径 | 策略研究 / 开发 |
...
| [策略升级与验证计划](strategy-upgrade-2026-07-12.md) | 策略修复、盘前首板扩容、历史 Shadow/回测闭环与 A/B 上线门槛 | 策略研究 / 开发 |
| [2026-07-14 策略优化复盘](strategy-review-2026-07-14.md) | 样本可靠性、情绪时效、仓位槽位、回测真实性与冻结验收 | 策略研究 / 开发 |
